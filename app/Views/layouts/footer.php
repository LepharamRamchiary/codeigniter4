            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-menu footer-menu-001">
                    <div class="footer-intro mb-4">
                        <a href="index.html">
                            <img src="<?= base_url(); ?>/public/assets/images/main-logo.png" alt="logo">
                        </a>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 d-flex flex-wrap">
                    <div class="shipping">
                        ...
                        <img src="<?= base_url(); ?>/public/assets/images/arct-icon.png" alt="icon">
                        <img src="<?= base_url(); ?>/public/assets/images/dhl-logo.png" alt="icon">
                    </div>
                    <div class="payment-option">
                        <span>Payment Option:</span>
                        <img src="<?= base_url(); ?>/public/assets/images/visa-card.png" alt="card">
                        <img src="<?= base_url(); ?>/public/assets/images/paypal-card.png" alt="card">
                        <img src="<?= base_url(); ?>/public/assets/images/master-card.png" alt="card">
                    </div>
                </div>
...
<script src="<?= base_url(); ?>/public/assets/js/SmoothScroll.js"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
    crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
<script src="<?= base_url(); ?>/public/assets/js/script.min.js"></script>
</body>
